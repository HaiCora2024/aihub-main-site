...
export const LaunchPhaseSection = ({
  mobile,
  className = "",
  style,
  ...
  return (
    <div
      className={`flex flex-col w-[204px] items-start gap-[29px] pt-[35px] pb-[30px] px-[15px] absolute top-[270px] left-[1106px] rounded-[20px] bg-[linear-gradient(180deg,rgba(8,208,112,0.15)_0%,rgba(8,208,112,0)_100%)] ${className}`.trim()}
      style={style}
    >
